...
// Global connection for botlibre sdk for avatar. Modify this and use API for the trained bot.
                ...
                if (Object.hasOwnProperty.call(response[i], "text")) {
                    if (response[i].text != null) {
                        ...
                        if (html.includes("<ul") || html.includes("<ol") || html.includes("<li") || html.includes('<h3')) {
                            ...
                            // botlibre message
                            // Consider not using markdown formatting or just extract text from markdown.
                            web.message(response[i].text);
